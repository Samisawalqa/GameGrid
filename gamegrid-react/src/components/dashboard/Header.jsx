                    ...
                    <div className="row justify-content-between align-items-center">
                        ...
                        <div className="app-utilities col-auto">
                            ...
                            <div className="app-utility-item app-user-dropdown dropdown">
                                <a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img className="rounded-circle" src="assets/images/user.png" alt="user profile" /></a>
        ...
        <div id="app-sidepanel" className="app-sidepanel">
            ...
            <div className="sidepanel-inner d-flex flex-column">
                ...
                <div className="app-branding">
                    <a className="app-logo" href="index.html"><img className="logo-icon me-2 rounded-circle" src="assets/images/gamegrid-logo.png" alt="logo" /><span className="logo-text">GameGrid</span></a>
                </div>{/*//app-branding*/}
